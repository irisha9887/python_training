...
def test_add_group_to_contact(app, orm):
    ...
    #with pytest.allure.step('When DB selects a random group'):
    ...
    app.navigation.open_home_page()
    #with pytest.allure.step('When DB selects a random contact from selected group'):
    ...
    #with pytest.allure.step('When I add a group to random contact %s' % selected_contact.id):
    ...
    #with pytest.allure.step('Then the new contact list is equal to the old list with the added group to one random contact'):
