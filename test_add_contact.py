...
def test_add_contact(app):
    ...
    app.create_contact(Contact(firstname="Kate", middlename="K.Smith", lastname="Smith", nickname="Katty", photo="/Users/i.mamutkina/Desktop/photo.png", title="Dev",
...
def test_add_empty_contact(app):
    app.open_edit_page()
    app.login(login="admin",  password="secret")
    app.create_contact(Contact(firstname="", middlename="", lastname="", nickname="", photo="/Users/i.mamutkina/Desktop/photo.png", title="", company="", address="",
